...
# make phpver3 to be phpzts82
RUN sed -i -e 's/_phpver2=82/_phpver2=zts82/' APKBUILD
RUN sed -i -e 's/.\/configure perl.*//' APKBUILD
...
RUN sed -i -e 's/perl php\$_phpver2 php\$_phpver3 php\$_phpver4/php\$_phpver2 /' APKBUILD
# make unit-php82 find the lphpzts82.so
# hadolint ignore=SC2016
RUN sed -i -e 's/.\/configure php --module=php\$_phpver2/sed -i -e "s\/lphp\/lphpzts\/g" auto\/modules\/php \&\& cat auto\/modules\/php \&\& .\/configure php --module=php\$_phpver2/g' APKBUILD
